...
---
### Using HTTP with TCP<img src="Pasted image 20251228233740.png" align="right" width="250" style="margin: 0 0 20px 30px;">
...
---
### Round Trip Time (RTT)<img src="Pasted image 20251228234055.png" align="right" width="300" style="margin: 0 0 20px 30px;">
...
<div style="display: flex; justify-content: center; gap: 20px; margin-bottom: 20px;">
  <img src="Pasted image 20251229000402.png" width="520">
  <img src="Pasted image 20251229000543.png" width="520">
</div>
---
...
---
#### Persistent HTTP Response Time<img src="Pasted image 20251228235146.png" align="right" width="570" style="margin: 50px 0 20px 30px;">
...
\r\n
```
**Key Parts Explained**:<img src="Pasted image 20251229005351.png" align="right" width="600" style="margin: -0px 20px 20px 30px;">
...
entity body
```
- <img src="Pasted image 20251229005851.png" align="right" width="350" style="margin: -0px 20px 20px 30px;">**Request line**: method + URL + version
...
**Structure**:<img src="Pasted image 20251229010349.png" align="right" width="600" style="margin: 50px 20px 20px 30px;">
...
**Typical Cookie Usage Steps**:<img src="Pasted image 20251229010937.png" align="right" width="700" style="margin: 20px 20px 20px 30px;">
...
<img src="Pasted image 20251229011754.png" align="right" width="600" style="margin: -120px 20px 20px 30px;">
**How it works**:
