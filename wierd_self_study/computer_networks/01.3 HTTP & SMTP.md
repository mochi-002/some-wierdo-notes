...
**Hypertext Transfer Protocol (HTTP)**  <img src="../../images/Pasted image 20251228232907.png" align="right" width="320" style="margin: 70px 0 20px 30px;">
...
---
### Using HTTP with TCP<img src="../../images/Pasted image 20251228233740.png" align="right" width="250" style="margin: 0 0 20px 30px;">
...
---
### Round Trip Time (RTT)<img src="../../images/Pasted image 20251228234055.png" align="right" width="300" style="margin: 0 0 20px 30px;">

- **Round Trip Time (RTT)**: Time for a small packet to travel from client to server and back → ***RTT = 2 × propagation time***
...
- Each object requires:
	- **1 RTT** for *TCP* connection setup
...
<div style="display: flex; justify-content: center; gap: 20px; margin-bottom: 20px;">
  <img src="../../images/Pasted image 20251229000402.png" width="520">
  <img src="../../images/Pasted image 20251229000543.png" width="520">
</div>
---
...
---
#### Persistent HTTP Response Time<img src="../../images/Pasted image 20251228235146.png" align="right" width="570" style="margin: 50px 0 20px 30px;">
...
\r\n
```
**Key Parts Explained**:<img src="../../images/Pasted image 20251229005351.png" align="right" width="600" style="margin: -0px 20px 20px 30px;">
...
entity body
```
- <img src="../../images/Pasted image 20251229005851.png" align="right" width="350" style="margin: -0px 20px 20px 30px;">**Request line**: method + URL + version
...
**Structure**:<img src="../../images/Pasted image 20251229010349.png" align="right" width="600" style="margin: 50px 20px 20px 30px;">
...
**Typical Cookie Usage Steps**:<img src="../../images/Pasted image 20251229010937.png" align="right" width="700" style="margin: 20px 20px 20px 30px;">
...
<img src="../../images/Pasted image 20251229011754.png" align="right" width="600" style="margin: -120px 20px 20px 30px;">
**How it works**:
